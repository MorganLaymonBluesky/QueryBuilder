...
public class QueryBuilder : IDisposable
{
    ...
    /*
       Write a Create method that will, regardless of T’s type, allow that object to be inserted into the database
    */
    ...
    /// <summary>
    /// Delete operation to remove all objects from a table in the SQLite database
    /// </summary>
